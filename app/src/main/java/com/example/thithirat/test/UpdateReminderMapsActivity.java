...
public class UpdateReminderMapsActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_update_reminder_maps);
    ...
    private void connect_location(double latitudefromselect, double longtitudefromselect, String placename) {
        try {
            RequestQueue requestQueue = Volley.newRequestQueue(UpdateReminderMapsActivity.this);
                        ...
                        public void onResponse(String response) {
                            ...
                            try {
                                ...
                                if(msg_location.equals("place/location : insert location complete")) {
                                    Toast.makeText(UpdateReminderMapsActivity.this, "Success", Toast.LENGTH_LONG).show();
                                }else {
                                    Toast.makeText(UpdateReminderMapsActivity.this, "Already", Toast.LENGTH_LONG).show();
                                }
