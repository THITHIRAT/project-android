...
public class UpdateEventMapsActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_update_event_maps);
                        ...
                        public void onResponse(String response) {
                            ...
                            try {
                                ...
                                if(msg_location.equals("place/location : insert location complete")) {
                                    Toast.makeText(UpdateEventMapsActivity.this, "Success", Toast.LENGTH_LONG).show();
                                }else {
                                    Toast.makeText(UpdateEventMapsActivity.this, "Already", Toast.LENGTH_LONG).show();
                                }
